...
import { useSortingAlgortihmContext } from "@/context/Visualizer";
      ...
      <div className="flex h-full justify-center">
        ...
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            <h1 className="text-gray-200 text-2xl font-light hidden md:flex">
              Sorting Visualizer
            </h1>
            <div className="flex items-center justify-center gap-4">
              ...
              >
                {requiresReset ? (
                  <RxReset className="text-gray-200 h-8 w-8" />
                ) : (
            ...
            <div className="hidden sm:flex absolute top-[120%] left-0 w-full">
              <div
                className="flex w-full text-gray-200 p-4 rounded border border-system-purple20 bg-system-purple80 bg-opacity-10 gap-6"
